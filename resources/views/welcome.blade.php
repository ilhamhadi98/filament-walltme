            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        <img class="h-12 w-auto text-white lg:h-16 lg:text-[#FF2D20]" viewBox="0 0 62 65" fill="none"
                            src="{{ asset('images/icons/w-logo.png') }}" alt="">
                    </div>
                    @if (Route::has('login'))
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-1 lg:gap-8">
                        ...
                        <div
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Manage your money from the
                                    earth 🌎</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Join the Financial Revolution with Walltme!
                                    </br>
                                    Managing your money has never been this fun and impactful. With Walltme, track your
                                    expenses, save smarter, and invest in a better future for yourself and the world.
                                    🌱✨
                                    </br>
                                    <a href="/admin">Start Your Journey Today! #SaveFuture #GenZFinance</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                    &#169; Walltme. #manageYourMoney {{ date('Y') }}
